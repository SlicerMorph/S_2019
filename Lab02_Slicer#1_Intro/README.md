...
* Temp folder setting: Where the temporarily files generated by Slicer are kept. You can modify this
...
* Cache folder setting: Where the downloaded files from internet (e.g., MorphoSource) will be stored. We suggest setting this to a folder called RemoteIO below the temp folder. 
